        ...
        <div className="contact-content">
          ...
          <div className="contact-info">
            <div className="contact-card">
              ...
              <span className="contact-card-data">zannatul.rakib@gmail.com</span>
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">Zannatul F Rakib</span>

              <a
                href="https://instagram.com/zannatul.rakib?utm_source=qr&igshid=ZDc4ODBmNjlmNQ%3D%3D"
                className="contact-button"
                target="_blank"
                rel="noreferrer noopener"
              >
